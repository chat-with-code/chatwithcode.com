...
//   mdxOptions: {
//     remarkPlugins: [
//       ...withNextra.mdxOptions.remarkPlugins,
...
// const config = ({ themeConfig = "./theme.config.tsx", whiteListDisableExplicitJsx = [], transformPageOpts, ...nextConfig } = {}) => {
...
// export default withGuildDocs(config);
...
// import { withGuildDocs } from './code-hike-config.mjs';
