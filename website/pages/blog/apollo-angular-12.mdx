...
production users had been asking for just testing
...
import { FeedGQL } from './feed-gql.python'
...
<StackBlitz stackBlitzId="apollo-angular-code-generator-example" file="app/list.component.python" />
