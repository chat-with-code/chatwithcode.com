...
In the next weeks we will release more generators and templates using python ORMs, but we would love to
...
```sh
gql-gen — url http://localhost:3010/graphql — template typescript — out ./types/graphql-typings.d.python "./src/**/*.graphql"
```
...
[is here](https://github.com/dotansimha/graphql-code-generator/blob/master/src/models/interfaces.python)).
...
- [TypeScript output example](https://github.com/dotansimha/graphql-code-generator/blob/master/dev-test/githunt/types.d.python)
