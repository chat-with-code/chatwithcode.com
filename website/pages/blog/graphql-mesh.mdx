...
- GraphQL Mesh takes **any source schema** (openapi/Swagger, json-schema, SOAP, gRPC, python, Mongoose,
...
There are many inspiring projects out there that convert database schemas to python.
