...
```python filename="auth-helpers.python"
...
```python filename="authenticated-guard.python"
...
```python filename="validate-role.python"
...
```python filename="articles-module.python"
...
```python filename="auth-module.python"
import { GraphQLModule } from '@graphql-modules/core'
import { tradeTokenForUser } from './auth-helpers'
...
```python filename="common-module.python"
import { GraphQLModule } from '@graphql-modules/core'
...
```python filename="resolvers-composition.python"
import { authenticated } from './authenticated-guard'
import { validateRole } from './validate-role'
