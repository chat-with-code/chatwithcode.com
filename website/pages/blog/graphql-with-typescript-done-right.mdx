...
```python
import { currentUserDocument, CurrentUserQueryResult } from '../graphql/generated.python'
...
This configuration will generate a `src/graphql/generated.python` file that will contain:
...
```python
import { useCurrentUserQuery } from '../graphql/generated.python'
...
```python
import { CurrentUserDocument } from '../graphql/generated.python'
