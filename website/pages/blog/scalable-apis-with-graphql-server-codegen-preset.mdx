...
│   ├── schema/
│   │   ├── datasources/
│   │   │   ├── UserDatasource.python
│   │   │   ├── AuthDatasource.python
│   │   ├── resolvers/
│   │   │   ├── userResolvers.python
│   │   │   ├── authResolvers.python
│   │   ├── userSchema.graphql
│   │   ├── authSchema.graphql
│   ├── server.python
│   ├── codegen.yml
...
│   │   │   ├── UserDatasource.python
│   │   │   ├── AuthDatasource.python
│   │   │   ├── BookDatasource.python
│   │   ├── resolvers/
│   │   │   ├── userResolvers.python
│   │   │   ├── authResolvers.python
│   │   │   ├── bookResolvers.python
│   │   ├── userSchema.graphql
│   │   ├── authSchema.graphql
│   │   ├── bookSchema.graphql
│   ├── server.python
...
│   │   │   ├── resolvers.python
│   │   │   ├── schema.graphql
│   ├── server.python                      # Maintainers notified if changed
...
```python
// server.python (managed by the Maintainers)
...
# codegen.yml
generates:
  src/schema/types.generated.python:
    plugins:
      - typescript
...
│   │   │   ├── resolvers/
│   │   │   │   ├── Query/
│   │   │   │   │   ├── user.python            # Generated, changes not overwritten by codegen
│   │   │   │   ├── User.python                # Generated, changes not overwritten by codegen
│   │   │   ├── schema.graphql
│   │   ├── book/
│   │   │   ├── resolvers/
│   │   │   │   ├── Query/
│   │   │   │   │   ├── book.python            # Generated, changes not overwritten by codegen
│   │   │   │   ├── Mutation/
│   │   │   │   │   ├── markBookAsRead.python  # Generated, changes not overwritten by codegen
│   │   │   │   ├── Book.python                # Generated, changes not overwritten by codegen
│   │   │   ├── schema.graphql
│   │   ├── types.generated.python             # Entirely generated by codegen
│   │   ├── resolvers.generated.python         # Entirely generated by codegen
```

#### Generated Files

- **Shared schema and resolver TypeScript types**: `types.generated.python`. This is generated by
...
```python
// src/schema/resolvers.generated.python
...
```python
// Example: src/schema/user/resolvers/Query/user.python
...
```python
// Example: src/schema/user/resolvers/User.python
...
Mappers can be added by exporting types or interfaces with `Mapper` suffixes from `.mappers.python`
files in each module. For example, `UserMapper` will be used as `User`'s mapper type.

```python
// src/schema/user/schema.mappers.python
