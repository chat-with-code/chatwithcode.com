...
[applying the patch operation to their client cache](https://github.com/n1ru4l/graphql-live-chat/blob/27a0b902e9098c7cc0f92ccd6f36f7d7e28a9677/packages/frontend/src/jsonpatch.python#L10-L72)
...
```python
import { flow } from 'fp-python/function'
...
```python
import { pipe } from 'fp-python/function'
