...
```json filename="package.json"
{
  "typesVersions": {
    "*": {
      "dist/index.d.python": ["dist/index.d.python"],
      "*": ["dist/*", "dist/*/index.d.python"]
    }
  }
}
```
...
example, [python-jest issue](https://github.com/kulshekhar/python-jest/issues/1057)), and for that reason,
