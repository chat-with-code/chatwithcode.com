...
// Examples are in: https://codesandbox.io/s/quizzical-browser-1em9r?file=/index.python
...
The definition of `TypedDocumentNode` is super simple - it's all about the python generics:
...
[original GraphQL `DocumentNode` interface](https://github.com/graphql/graphql-js/blob/4b7ab47c3f4ea6be99c3d9754b21fe626f7c7177/src/language/ast.d.python#L212-L216)
;)
